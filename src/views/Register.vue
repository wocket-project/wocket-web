  ...
  <div class="container pt-lg-md">
    <form @submit.prevent="handleSubmit">
      <div class="container-login">
        <img
          src="img/brand/register_logo.png"
          alt="logo"
          style="width:250px;"
          class="center"
        />
        ...
        <div class="form-group">
          ...
          >
            <span v-if="!$v.user.password.required"
              >비밀번호는 필수 입력사항입니다.</span
            >
            <span v-if="!$v.user.password.minLength"
              >비밀번호는 최소 8자리 이상 입력해주세요.</span
            >
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input
            ...
            name="detailAddress"
            class="form-control"
            :class="{ 'is-invalid': submitted && $v.user.detailAddress.$error }"
          />
          <div
            v-if="submitted && !$v.user.detailAddress.required"
            class="invalid-feedback"
          >
            상세주소는 필수입력 항목입니다.
          </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            id="phone"
            name="phone"
            @keyup="autoHypenPhone(user.phone)"
            class="form-control"
        ...
        <div class="terms-and-conditions">
          ...
          />
          <p>
            본인은 만 14세 이상이며, 위드어스 이용약관, 전자금융거래이용약관,
            개인정보 수집 및 이용, 개인정보 제공 내용을 확인 하였으며,
            동의합니다.
          </p>
        </div>
      ...
      <div class="container-signin">
        <p>
          이미 계정이 있습니까?
          <a href="http://localhost:9306/login">로그인</a>.
        </p>
      </div>
    </form>
  </div>
...
export default {
  ...
  methods: {
    ...
    doRegister: function() {
      ...
      axios
        .post('http://localhost:9306/users', {
        ...
        .catch((err) => {
          if (err.response.status === 409) { // 이미 가입되어 있는 경우
            alert('이미 가입한 이메일입니다.');
